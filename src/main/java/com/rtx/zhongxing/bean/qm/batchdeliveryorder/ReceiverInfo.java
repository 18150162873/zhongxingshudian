...
public class ReceiverInfo {
	...
	private String name;//姓名, string (50) , 必填
	private String zipCode;//邮编, string (50)
	private String tel;//固定电话, string (50)
	private String mobile;//移动电话, string (50) , 必填
	private String idType;//收件人证件类型，string (50)， 1-身份证 2-军官证 3-护照 4-其他
	private String idNumber;//收件人证件号码，string (50)
	private String email;//电子邮箱, string (50)
	private String countryCode;//国家二字码，string（50）
	private String province;//省份, string (50) , 必填
	private String city;//城市, string (50) , 必填
	private String area;//区域, string (50)
	private String town;//村镇, string (50)
	private String detailAddress;//详细地址, string (200) , 必填
